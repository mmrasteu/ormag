...
/************ GENERAR PDF CON LOS DATOS SEGUN EL USERNAME INDICADO ***************/
	...
	ob_start();
		...
		<table width=600 cellpadding=2 cellspacing=0 border=1>
			<tr> <th colspan=6> INFORME DE LA BUSQUEDA DE \"%s\" POR NOMBRE DE USUARIO </th> </tr>
	...
	$dompdf->render();
	$pdf = $dompdf->output();
	$filename = "PDFuserName_".time().'.pdf';
