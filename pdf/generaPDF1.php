...
/************ GENERAR PDF CON LOS DATOS DE TODOS LOS USUARIOS ***************/
	...
	ob_start();
		...
		<table width=600 cellpadding=2 cellspacing=0 border=1>
			<tr> <th colspan=6> INFORME DE TODOS LOS USUARIOS EN LA BASE DE DATOS ORMAG </th> </tr>
	...
	$dompdf->render();
	$pdf = $dompdf->output();
	$filename = "PDFallUsers_".time().'.pdf';
