...
/************ GENERAR PDF CON LOS DATOS DE PIEZAS SEGUN EL NUMERO DE SERIE ***************/
	...
	ob_start();
		...
		<table width=600 cellpadding=2 cellspacing=0 border=1>
			<tr> <th colspan=6> INFORME SEGUN NÚMERO DE SERIE   \"%s\"   EN LA BASE DE DATOS ORMAG </th> </tr>
	...
	$dompdf->render();
	$pdf = $dompdf->output();
	$filename = "PDFpiezasNSerie_".time().'.pdf';
